;;;; (asdf:test-system 'cl-idx)

(in-package :cl-idx-tests)

(alexandria:define-constant +all-tests+
    '(;; UINT8
...
(fiveam:def-suite read-tests
    :description "cl-idx read tests suite"
    :in all-tests)

(fiveam:def-suite write-tests
    :description "cl-idx write tests suite"
    :in all-tests)

(generate-tests read-tests write-tests)
